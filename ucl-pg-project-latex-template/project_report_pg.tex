...
% \begin{table}[htbp]
%   \caption{Table summarising the difference in distributions 
%   among triangle counts, clustering coefficients and node 
%   degrees. The ``difference'' is measured by applying a two 
%   sample Kolmogorov-Smirnov test. The significance level is $\%5$.}
%   \centering
...
%     & Number of bob required to pass & Cumulative Total of Courses & Number of courses &         Cumulative Total of Courses\\
%     \midrule
%     First year & 4 & 8 & 4 & 18 \\
%     \bottomrule
%   \end{tabular}
...
%     \multicolumn{2}{c}{B.Bus.Sci} \\
%     \cmidrule(r{4pt}){2-3} \cmidrule(l){4-5}
%     & bobec & Number of bob required to pass & Cumulative Total of Courses & Number of courses &         Cumulative Total of Courses\\
%     \midrule
%     First year & 4 & 8 & 4 & 18 \\
%     \bottomrule
%   \end{tabular}
