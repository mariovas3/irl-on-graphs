...
\begin{figure}[H]
  \includegraphics[scale=0.5]{GO_schematic.png}
...
have the actions in the range $(-1, 1)$. To make this work 
...
original paper was due to working with the MuJoCo environment 
